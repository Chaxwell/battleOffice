...
class Client
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\ClientDeliveryAddress", cascade={"persist", "remove"})
     */
    private $clientDeliveryAddress;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Order", mappedBy="client", cascade={"persist", "remove"})
     */
    private $clientOrder;
    ...
    public function setClientOrder(?Order $clientOrder): self
    {
        ...
        $newClient = $clientOrder === null ? null : $this;
        if ($newClient !== $clientOrder->getClient()) {
            $clientOrder->setClient($newClient);
        }
